---
layout: post
title: "List: Morton's neuroma treatments"
subtitle: "A comprehensive list of conservative treatments"
categories: health
...
* 3 weeks: ankle still hurts and got first inklings of neuroma; get x-rays from doctor and he refers me to a podiatrist (Dr. Hershman)
...
* (Later: Saw Dr. Blake, learned that 0-2 is an acceptable level of pain for activity, new orthotics, alcohol injections, PT at better clinic for 1+ year, saw dismissive neurologist, a couple sessions of dry needling and learned about "learned pain", then just went for it)
